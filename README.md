...
let
  nixos-locale = fetchGit {
    url = "https://github.com/<YOUR_USERNAME>/nixos-locale.git";
    ref = "main";
...
```bash
git clone https://github.com/<YOUR_USERNAME>/nixos-locale.git &&
cd nixos-locale &&
...
- 🕒 [timedatectl man page](https://man7.org/linux/man-pages/man1/timedatectl.1.html) : Learn how to inspect and configure system time and timezone.
- 🧠 [GNU libc locales](https://www.gnu.org/software/libc/manual/html_node/Locales.html) : In-depth explanation of locale categories.
